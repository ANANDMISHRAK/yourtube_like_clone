...
36. who is current user -> send to frontend
    ...
    - 36.1) req.user gives who is current user all information at time of login
...
41. how to find subscriber : How many people follow you i.e. : Follower
    ...
    - step 1 -> subscription collection ko left join krna hoga user collection ke sath so need aggregation pipline
...
5.  change the publice status of video : - step 1) - take video id from url
